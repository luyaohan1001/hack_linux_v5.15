...
#line 4 "/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/build/host-qemu-6.2.0/target/mips/tcg/trace-events"
...
static inline void _nocheck__trace_mips_translate_tr(const char * instr, int rt, int u, int sel, int h)
{
    if (trace_event_get_state(TRACE_MIPS_TRANSLATE_TR) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 5 "/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/build/host-qemu-6.2.0/target/mips/tcg/trace-events"
