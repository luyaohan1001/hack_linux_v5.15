...
#line 4 "/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/build/host-qemu-6.2.0/target/i386/kvm/trace-events"
...
static inline void _nocheck__trace_kvm_x86_add_msi_route(int virq)
{
    if (trace_event_get_state(TRACE_KVM_X86_ADD_MSI_ROUTE) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 5 "/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/build/host-qemu-6.2.0/target/i386/kvm/trace-events"
...
static inline void _nocheck__trace_kvm_x86_remove_msi_route(int virq)
{
    if (trace_event_get_state(TRACE_KVM_X86_REMOVE_MSI_ROUTE) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 6 "/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/build/host-qemu-6.2.0/target/i386/kvm/trace-events"
...
static inline void _nocheck__trace_kvm_x86_update_msi_routes(int num)
{
    if (trace_event_get_state(TRACE_KVM_X86_UPDATE_MSI_ROUTES) && qemu_loglevel_mask(LOG_TRACE)) {
        if (message_with_timestamp) {
            struct timeval _now;
            gettimeofday(&_now, NULL);
#line 7 "/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/build/host-qemu-6.2.0/target/i386/kvm/trace-events"
