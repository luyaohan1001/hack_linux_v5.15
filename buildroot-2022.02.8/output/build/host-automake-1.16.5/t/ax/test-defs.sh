...
am_rel_srcdir='.'
am_top_srcdir='/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/build/host-automake-1.16.5'
am_top_builddir='/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/build/host-automake-1.16.5'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/host/share/automake-1.16/am'
    am_automake_acdir='/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/host/share/aclocal-1.16'
    am_bindir='/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/host/bin'
    am_datadir='/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/host/share'
    am_docdir='/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/host/share/doc/automake'
    am_pkgvdatadir='/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/host/share/automake-1.16'
    am_scriptdir='/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/host/share/automake-1.16'
    am_system_acdir='/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/host/share/aclocal'
    ;;
  no)
...
CFLAGS=${AM_TESTSUITE_CFLAGS-${CFLAGS-'-O2 -I/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/host/include'}}
CXXFLAGS=${AM_TESTSUITE_CXXFLAGS-${CXXFLAGS-'-O2 -I/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/host/include'}}
FCFLAGS=${AM_TESTSUITE_FCFLAGS-${FCFLAGS-''}}
FFLAGS=${AM_TESTSUITE_FFLAGS-${FFLAGS-''}}
CPPFLAGS=${AM_TESTSUITE_CPPFLAGS-${CPPFLAGS-'-I/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/host/include'}}
...
GNU_CXXFLAGS=${AM_TESTSUITE_GNU_CXXFLAGS-${GNU_CXXFLAGS-'-O2 -I/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/host/include'}}
GNU_CFLAGS=${AM_TESTSUITE_GNU_CFLAGS-${GNU_CFLAGS-'-O2 -I/home/luyaohan1001/Projects/hack_linux_v5.15/buildroot-2022.02.8/output/host/include'}}
