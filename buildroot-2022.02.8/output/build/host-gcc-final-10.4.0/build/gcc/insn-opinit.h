...
#define NUM_OPTAB_PATTERNS  1668
...
extern insn_code maybe_code_for_lwp_slwpcb_1 (machine_mode);
inline insn_code
code_for_lwp_slwpcb_1 (machine_mode arg0)
{
  insn_code code = maybe_code_for_lwp_slwpcb_1 (arg0);
  gcc_assert (code != CODE_FOR_nothing);
  return code;
}

extern rtx maybe_gen_lwp_slwpcb_1 (machine_mode, rtx);
inline rtx
gen_lwp_slwpcb_1 (machine_mode arg0, rtx x0)
{
  rtx res = maybe_gen_lwp_slwpcb_1 (arg0, x0);
  gcc_assert (res);
  return res;
}
